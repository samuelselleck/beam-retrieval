...
def plot_profile(fig, F_behind, dist_to_focus):
    metrics = field_analysis.get_slice_metrics(F_behind, dist_to_focus, steps=100)
    fig.clear()
    ax = fig.subplots()
    x_name = "Distance From Focus"
    y_names = ["Strehl Ratio"]
